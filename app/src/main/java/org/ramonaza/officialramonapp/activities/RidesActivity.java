...
import org.ramonaza.officialramonapp.uifragments.rides_activity.AlephsFragment;
import org.ramonaza.officialramonapp.uifragments.rides_activity.DriversFragment;
...
public class RidesActivity extends Activity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.rides_title_section1).toUpperCase(l);
                case 1:
                    return getString(R.string.rides_title_section2).toUpperCase(l);
            }
            return null;
        }
    }
